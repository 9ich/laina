...
//========================================================================
int
BotValidWeaponNumber(int weaponnum)
{
...
//========================================================================
bot_weaponstate_t *
BotWeaponStateFromHandle(int handle)
{
...
#ifdef DEBUG_AI_WEAP
void
DumpWeaponConfig(weaponconfig_t *wc)
{
	FILE *fp;
	int i;
...
#endif	//DEBUG_AI_WEAP
weaponconfig_t *
LoadWeaponConfig(char *filename)
{
...
int *
WeaponWeightIndex(weightconfig_t *wwc, weaponconfig_t *wc)
{
	int *index, i;
...
void
BotFreeWeaponWeights(int weaponstate)
{
...
int
BotLoadWeaponWeights(int weaponstate, char *filename)
{
	bot_weaponstate_t *ws;
...
void
BotGetWeaponInfo(int weaponstate, int weapon, weaponinfo_t *weaponinfo)
{
	bot_weaponstate_t *ws;
...
int
BotChooseBestFightWeapon(int weaponstate, int *inventory)
{
...
void
BotResetWeaponState(int weaponstate)
{
}
