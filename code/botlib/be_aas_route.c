...
AAS_ClusterAreaNum(int cluster, int areanum)
{
...
void
AAS_InitTravelFlagFromType(void)
{
	int i;
...
static ID_INLINE int
AAS_TravelFlagForType_inline(int traveltype)
{
	int tfl = 0;
...
void
AAS_UnlinkCache(aas_routingcache_t *cache)
{
	if(cache->time_next)
...
void
AAS_LinkCache(aas_routingcache_t *cache)
{
...
void
AAS_FreeRoutingCache(aas_routingcache_t *cache)
{
...
void
AAS_RemoveRoutingCacheInCluster(int clusternum)
{
	int i;
...
void
AAS_RemoveRoutingCacheUsingArea(int areanum)
{
	int i, clusternum;
	aas_routingcache_t *cache, *nextcache;
...
int
AAS_EnableRoutingArea(int areanum, int enable)
{
	int flags;
...
int
AAS_GetAreaContentsTravelFlags(int areanum)
{
	int contents, tfl;
...
void
AAS_InitAreaContentsTravelFlags(void)
{
	int i;
...
void
AAS_CreateReversedReachability(void)
{
	int i, n;
...
ushort
AAS_AreaTravelTime(int areanum, vec3_t start, vec3_t end)
{
	int intdist;
	float dist;
	vec3_t dir;
...
void
AAS_CalculateAreaTravelTimes(void)
{
	int i, l, n, size;
	char *ptr;
	vec3_t end;
...
int
AAS_PortalMaxTravelTime(int portalnum)
{
	int l, n, t, maxt;
	aas_portal_t *portal;
	aas_reversedreachability_t *revreach;
...
void
AAS_InitPortalMaxTravelTimes(void)
{
	int i;
...
void
AAS_FreeAllClusterAreaCache(void)
{
	int i, j;
	aas_routingcache_t *cache, *nextcache;
	aas_cluster_t *cluster;
...
void
AAS_CreateAllRoutingCache(void)
{
	int i, j;
	//int t;
...
void
AAS_InitReachabilityAreas(void)
{
...
void
AAS_UpdateAreaRoutingCache(aas_routingcache_t *areacache)
{
...
aas_routingcache_t *
AAS_GetAreaRoutingCache(int clusternum, int areanum, int travelflags)
{
	int clusterareanum;
...
void
AAS_UpdatePortalRoutingCache(aas_routingcache_t *portalcache)
{
...
aas_routingcache_t *
AAS_GetPortalRoutingCache(int clusternum, int areanum, int travelflags)
{
	aas_routingcache_t *cache;
...
int
AAS_AreaRouteToGoalArea(int areanum, vec3_t origin, int goalareanum, int travelflags, int *traveltime, int *reachnum)
{
...
int
AAS_AreaTravelTimeToGoalArea(int areanum, vec3_t origin, int goalareanum, int travelflags)
{
...
int
AAS_AreaReachabilityToGoalArea(int areanum, vec3_t origin, int goalareanum, int travelflags)
{
	int traveltime, reachnum = 0;
...
int
AAS_PredictRoute(struct aas_predictroute_s *route, int areanum, vec3_t origin,
...
int
AAS_NextAreaReachability(int areanum, int reachnum)
{
	aas_areasettings_t *settings;
...
int
AAS_NextModelReachability(int num, int modelnum)
{
	int i;
...
int
AAS_RandomGoalArea(int areanum, int travelflags, int *goalareanum, vec3_t goalorigin)
{
	int i, n, t;
	vec3_t start, end;
	aas_trace_t trace;
...
int
AAS_NearestHideArea(int srcnum, vec3_t origin, int areanum, int enemynum, vec3_t enemyorigin, int enemyareanum, int travelflags)
{
