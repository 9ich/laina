...
*/
void
setlerpframeanimation(animation_t *anims, lerpframe_t *lf, int newanim)
{
	animation_t *anim;
...
runlerpframe(animation_t *anims, lerpframe_t *lf, int newanim, float speedscale)
{
	...
	if(newanim != lf->animnum || !lf->animation)
		setlerpframeanimation(anims, lf, newanim);
...
models/crates/bouncy/animation.cfg, etc.

See also cg_players.c:/parseplayeranimfile/
*/
qboolean
