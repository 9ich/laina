...
void GfxInfo_f( void ) 
{
	...
	ri.Printf( PRINT_DEVELOPER, "\npixel format: color(%d-bits) Z(%d-bit) stencil(%d-bits)\n", glConfig.colorBits, glConfig.depthBits, glConfig.stencilBits );
...
void R_Register( void ) 
{
	...
	r_ext_max_anisotropy = ri.Cvar_Get( "r_ext_max_anisotropy", "0", CVAR_ARCHIVE | CVAR_LATCH );
	...
	r_textureMode = ri.Cvar_Get( "r_textureMode", "GL_NEAREST", CVAR_ARCHIVE );
