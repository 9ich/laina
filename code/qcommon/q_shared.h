...
#ifdef STANDALONE
  #define PRODUCT_NAME			"bunny"
  #define BASEGAME			"foobar"
  #define CLIENT_WINDOW_TITLE     	"bunny"
  #define CLIENT_WINDOW_MIN_TITLE 	"bunny?"
...
/**********************************************************************
  ...
  using the compiler they were meant for.  We use bg_libc.h which contains
  prototypes for the functions we define for our own use in bg_libc.c.

  When writing mods, please add needed headers HERE, do not start including
  stuff like <stdio.h> in the various .c files that make up each of the VMs
  since you will be including system headers files can will have issues.

  Remember, if you use a C library function that is not defined in bg_libc.c,
...
#define UI_HIGHLIGHT		0x00008000
...
#define	BUTTON_TALK		(1<<2)	// displays talk balloon and disables actions
#define	BUTTON_USE_HOLDABLE	(1<<3)
#define	BUTTON_GESTURE		(1<<4)
#define	BUTTON_WALKING		(1<<5)	// walking can't just be infered from MOVE_RUN
...
#define	BUTTON_ANY			(1<<12)	// any key whatsoever
